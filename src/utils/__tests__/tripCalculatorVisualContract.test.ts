...
const tripCalculatorRoot = resolve(workspaceRoot, "src/components/trip-calculator");
...
const protectedFiles = collectSourceFiles(tripCalculatorRoot);
...
describe("contrato visual de calculadora de viajes", () => {
