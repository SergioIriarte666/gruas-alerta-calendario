...
const closuresRoot = resolve(workspaceRoot, "src/components/closures");
...
const protectedFiles = collectSourceFiles(closuresRoot);
...
describe("contrato visual de cierres", () => {
