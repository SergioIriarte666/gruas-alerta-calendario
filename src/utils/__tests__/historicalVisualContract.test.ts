...
const historicalRoot = resolve(workspaceRoot, "src/components/finance/historical");
...
const historicalFiles = collectSourceFiles(historicalRoot);
...
describe("contrato visual del histórico financiero", () => {
  it.each(historicalFiles)("mantiene estilos semánticos en %s", (file) => {
