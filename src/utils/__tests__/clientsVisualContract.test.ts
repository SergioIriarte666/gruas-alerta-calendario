...
const clientsRoot = resolve(workspaceRoot, "src/components/clients");
...
const protectedFiles = [
  ...collectSourceFiles(clientsRoot),
  resolve(workspaceRoot, "src/utils/departmentColors.ts"),
];
...
describe("contrato visual de clientes", () => {
