-- Eliminar funciones existentes y recrearlas con tipos correctos
...
-- Recrear apply_payment_manual con tipos correctos
...
-- Recrear apply_payment_fifo con tipos correctos
