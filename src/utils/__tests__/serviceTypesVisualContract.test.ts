...
const serviceTypesRoot = resolve(workspaceRoot, "src/components/service-types");
...
const protectedFiles = collectSourceFiles(serviceTypesRoot);
...
describe("contrato visual de tipos de servicio", () => {
