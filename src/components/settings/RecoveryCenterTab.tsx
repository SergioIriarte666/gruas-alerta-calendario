...
export const RecoveryCenterTab = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <Alert className="border-amber-300 bg-amber-50/80 text-amber-950"><GitBranch className="size-4 !text-amber-700" /><AlertTitle>Git no revierte datos de Supabase</AlertTitle><AlertDescription>Los cambios de código y los datos operacionales tienen historiales distintos. Use siempre la vista previa antes de recuperar.</AlertDescription></Alert>
