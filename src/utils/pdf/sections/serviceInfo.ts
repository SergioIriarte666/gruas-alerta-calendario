...
export const addServiceInfo = (doc: jsPDF, data: InspectionPDFData, yPosition: number): number => {
  try {
    ...
    const serviceData = [
      ...
      ['Kilometraje:', data.inspection.kilometraje || 'N/A'],
      ['Combustible:', data.inspection.combustible || 'N/A'],
      ['Llaves del Vehículo:', data.inspection.llaves || 'N/A'],
      ['Documentación del Vehículo:', data.inspection.documentacion || 'N/A'],
