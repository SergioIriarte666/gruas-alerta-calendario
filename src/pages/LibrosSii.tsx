  ...
  return (
    <div className="animate-in fade-in duration-500 space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-xl font-bold tracking-tight sm:text-3xl">Libros SII</h1>
        <p className="text-muted-foreground">
          Registro de Compras y Ventas (RCV) del SII importado desde CSV, y cruce con los costos registrados por equipo.
        </p>
      </div>
