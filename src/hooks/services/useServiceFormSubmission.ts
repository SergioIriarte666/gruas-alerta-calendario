  ...
  const handleSubmit = async (
    ...
    const submissionData = {
      ...
      serviceType: {
        ...
        basePrice: selectedServiceType.basePrice,
        isActive: selectedServiceType.isActive,
        vehicleInfoOptional: selectedServiceType.vehicleInfoOptional,
        purchaseOrderRequired: selectedServiceType.purchaseOrderRequired,
        originRequired: selectedServiceType.originRequired,
        destinationRequired: selectedServiceType.destinationRequired,
        craneRequired: selectedServiceType.craneRequired,
        operatorRequired: selectedServiceType.operatorRequired,
        vehicleBrandRequired: selectedServiceType.vehicleBrandRequired,
        vehicleModelRequired: selectedServiceType.vehicleModelRequired,
        licensePlateRequired: selectedServiceType.licensePlateRequired,
