      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label className="text-sm text-muted-foreground">Grúa</Label>
            ...
            <div className="space-y-2">
              <Label className="text-sm text-muted-foreground">Tipo de Mantenimiento</Label>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-end">
            <div className="space-y-2 flex-1 max-w-sm">
              ...
              <Input
                ...
                className="h-10 bg-background/50 border-border placeholder:text-muted-foreground"
              />
            </div>
