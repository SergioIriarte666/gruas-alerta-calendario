-- Eliminar trigger antes de recrear la función

-- Eliminar trigger existente
DROP TRIGGER IF EXISTS maintain_payment_consistency_trigger ON payment_applications;

-- Eliminar y recrear función maintain_payment_consistency
DROP FUNCTION IF EXISTS public.maintain_payment_consistency() CASCADE;
...
BEGIN
  ...
  IF TG_TABLE_NAME = 'payment_applications' THEN
    ...
    BEGIN
      ...
      -- Actualizar el pago (sin tocar remaining_amount)
      UPDATE payments 
      SET 
...
-- Eliminar y recrear función fix_payment_system_inconsistencies
