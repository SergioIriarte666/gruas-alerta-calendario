...
const dailyReportRoot = resolve(workspaceRoot, "src/components/daily-report");
...
const protectedFiles = collectSourceFiles(dailyReportRoot);
...
describe("contrato visual del reporte diario", () => {
