  ...
  return <div className="flex items-center justify-center min-h-screen bg-transparent">
      <div className="w-[400px]">
        ...
        <div className="flex w-full bg-black/20 rounded-lg p-1 mb-4">
          <button onClick={() => setActiveTab('login')} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'login' ? 'bg-white text-gray-900' : 'text-white hover:text-gray-300'}`}>
            Iniciar Sesión
          </button>
          <button onClick={() => setActiveTab('register')} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'register' ? 'bg-white text-gray-900' : 'text-white hover:text-gray-300'}`}>
            Registrarse
          </button>
        </div>

        {/* Login Tab Content */}
        {activeTab === 'login' && <Card className="glass-card border-0">
            <CardHeader>
        ...
        {activeTab === 'register' && <Card className="glass-card border-0">
            <CardHeader>
