...
export const CraneDetailsModal = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="cranes-modal cranes-modal--details resources-dialog h-[92dvh] max-w-7xl overflow-hidden flex flex-col border-border/70 bg-card p-0">
