...
function StatusBadge({ operation }: { operation: RecoveryOperation }) {
  ...
  if (operation.status === 'blocked') return <Badge variant="outline" className="gap-1 border-border bg-muted text-muted-foreground"><Ban className="size-3" />No reversible</Badge>;
  return <Badge variant="outline" className="gap-1 border-success/30 bg-success-soft text-success"><ShieldCheck className="size-3" />Reversible</Badge>;
}
