...
const inventoryRoot = resolve(workspaceRoot, "src/components/inventory");
...
const protectedFiles = collectSourceFiles(inventoryRoot);
...
describe("contrato visual de inventario", () => {
