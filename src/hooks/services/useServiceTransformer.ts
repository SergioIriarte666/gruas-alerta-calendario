    ...
    return data.map((item: any) => {
      ...
      const transformedService: Service = {
        ...
        client: embeddedClient ? {
          ...
          contactName: embeddedClient.contact_name || '',
          ...
          contactName: embeddedThirdPartyClient.contact_name || '',
        ...
        originLocationSource: item.origin_location_source ?? null,
        destination: item.destination || '',
        destinationLat: item.destination_lat ?? null,
        destinationLng: item.destination_lng ?? null,
        destinationLocationSource: item.destination_location_source ?? null,
