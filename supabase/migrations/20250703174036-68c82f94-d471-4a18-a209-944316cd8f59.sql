-- Primero eliminar la restricción de unicidad que causa conflictos
ALTER TABLE public.costs DROP CONSTRAINT IF EXISTS costs_description_date_key;

-- Luego actualizar costos con descripciones con IDs aleatorios a descripciones legibles
UPDATE public.costs 
