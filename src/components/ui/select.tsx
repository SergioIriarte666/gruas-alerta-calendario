...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-black border-tms-green/30 text-white",
      className
    )}
    style={{ 
      background: '#000000',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-black border-tms-green text-white",
        className
      )}
      position={position}
      style={{
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-white hover:bg-tms-green/20 focus:bg-tms-green/20 data-[state=checked]:bg-tms-green/30",
      className
    )}
    style={{ color: '#ffffff' }}
    {...props}
  >
    ...
    <SelectPrimitive.ItemText style={{ color: '#ffffff' }}>
      {children}
