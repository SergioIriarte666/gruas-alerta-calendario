...
const protectedRoots = [
  resolve(workspaceRoot, "src/components/cranes"),
  resolve(workspaceRoot, "src/components/services"),
];
...
const protectedFiles = protectedRoots.flatMap(collectSourceFiles);
...
const legacyTmsClass = /(?:text|bg|border)-tms-[a-z-]+(?:\/[0-9]+)?/g;
...
describe("contrato visual del núcleo operativo", () => {
