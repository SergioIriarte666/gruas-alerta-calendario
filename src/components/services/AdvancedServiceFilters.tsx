...
import { formatForDisplay, parseFromDatabase, formatForDatabase } from '@/utils/timezoneUtils';
...
export const AdvancedServiceFilters: React.FC<AdvancedServiceFiltersProps> = ({
  ...
  const handleDateSelect = (field: keyof AdvancedFilters, date: Date | undefined) => {
    onFiltersChange({
      ...filters,
      [field]: date ? formatForDatabase(date) : undefined
    });
  };
      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {value ? formatForDisplay(value) : 'Seleccionar fecha'}
          </Button>
        </PopoverTrigger>
        <PopoverContent className="w-auto p-0 bg-white" align="start">
          <Calendar
            mode="single"
            selected={value ? parseFromDatabase(value) : undefined}
