...
export const XMLDocumentUpload: React.FC<XMLDocumentUploadProps> = ({
  ...
  const { createPayment } = useSupplierPayments();
                ...
                <CardContent>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setCreatePayments(checked === true)}
                    />
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-800 rounded">
                          ...
                          <div className="flex items-center space-x-2">
                            <Select
                              ...
                              onValueChange={(value) => handleCategoryChange(supplier.rut, value as SupplierCategory)}
                            >
