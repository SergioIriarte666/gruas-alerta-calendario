-- Mejorar el sistema de facturas vencidas
-- =====================================================
...
-- 2. Crear función para corrección manual de facturas vencidas existentes
...
BEGIN
  ...
  RAISE NOTICE 'Facturas vencidas actualizadas exitosamente';
END;
$$;
